...
https://github.com/EMakosch161/CS283

4. Briefly describe what you want to get out of this class.
I want to build my knowledge and experience with C. I also want to be able to use the projects and assignments I make in this class
to add to a personal website to demonstrate my skills to employers.

5. Briefly describe any concerns you might be having with being successful in this class (if any).
I'm worried that I'm not as fluent in C as I should be, and that if I have to play a little more catchup than needed, I will fall behind